...
"""
Custom topology for vSDNEmul, generated by GraphML-Topo-to-VSDNEmul-Network-Generator.
"""
...
for e in edge_set:
    ...
    temp4 +=  "link_wh"
    temp4 += str(z)
    temp4 += " = dp.addLink(LinkPair(name='link_wh" #criar funcao para pegar o tipo de link futuramente
    temp4 += str(z)
    temp4 += "'"
    temp4 += ", node_source="
...
outputfile = ''
if output_file_name == '':
    output_file_name = input_file_name + '-generated-vSDNemul-topology.py'
