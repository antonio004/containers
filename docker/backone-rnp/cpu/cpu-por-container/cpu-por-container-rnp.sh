# /bin/bash
echo "Contador cpu$" >>"cpu-tree-containers".ods
i=0
...
do	
	...
	echo $contr $stch0 $stch1 $stch2 $stch3 $stch4 $stch5 $stch6 $stch7 $stch8 $stch9 $stch10 $stch11 $stch12 $stch13 $stch14 $stch15 $stch16 $stch17 $stch18 $stch19 $stch20 $stch21 $stch22 $stch23 $stch24 $stch25 $stch26 $stch27 $stch28 $stch29 $stch30 $host0 $host1 $host2 $host3 $host4 >>"cpu-tree-containers".ods
	i=`expr $i + 1`
done
