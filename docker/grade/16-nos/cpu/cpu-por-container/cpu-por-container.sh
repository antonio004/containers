# /bin/bash
echo "Contador cpu$" >>"cpu-grade16-containers".ods
i=0
...
do	
	...
	echo $contr $stch0 $stch1 $stch2 $stch3 $stch4 $stch5 $stch6 $stch7 $stch8 $stch9 $stch10 $stch11 $stch12 $stch13 $stch14 $stch15 $host0 $host1 >>"cpu-grade16-containers".ods
	i=`expr $i + 1`
done
