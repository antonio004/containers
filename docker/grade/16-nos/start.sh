...
#sw3 x sw7
docker exec sw3 ovs-vsctl add-port s3 gre1 -- set interface gre1 type=gre options:remote_ip=172.28.5.8
docker exec sw7 ovs-vsctl add-port s7 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.4
...
#sw4 x sw8
docker exec sw4 ovs-vsctl add-port s4 gre2 -- set interface gre2 type=gre options:remote_ip=172.28.5.9
docker exec sw8 ovs-vsctl add-port s8 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.5

#sw5 x sw9
docker exec sw5 ovs-vsctl add-port s5 gre3 -- set interface gre3 type=gre options:remote_ip=172.28.5.10
docker exec sw9 ovs-vsctl add-port s9 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.6

#sw6 x sw10
docker exec sw6 ovs-vsctl add-port s6 gre3 -- set interface gre3 type=gre options:remote_ip=172.28.5.11
docker exec sw10 ovs-vsctl add-port s10 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.7

#sw7 x sw11
docker exec sw7 ovs-vsctl add-port s7 gre2 -- set interface gre2 type=gre options:remote_ip=172.28.5.12
docker exec sw11 ovs-vsctl add-port s11 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.8
...
#sw9 x sw10
docker exec sw9 ovs-vsctl add-port s9 gre2 -- set interface gre2 type=gre options:remote_ip=172.28.5.11
docker exec sw10 ovs-vsctl add-port s10 gre1 -- set interface gre1 type=gre options:remote_ip=172.28.5.10

#sw10 x sw11
docker exec sw10 ovs-vsctl add-port s10 gre2 -- set interface gre2 type=gre options:remote_ip=172.28.5.12
...
#sw9 x sw13
docker exec sw9 ovs-vsctl add-port s9 gre3 -- set interface gre3 type=gre options:remote_ip=172.28.5.14
docker exec sw13 ovs-vsctl add-port s13 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.10

#sw10 x sw14
docker exec sw10 ovs-vsctl add-port s10 gre3 -- set interface gre3 type=gre options:remote_ip=172.28.5.15
docker exec sw14 ovs-vsctl add-port s14 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.11

#sw11 x sw15
docker exec sw11 ovs-vsctl add-port s11 gre2 -- set interface gre2 type=gre options:remote_ip=172.28.5.16
docker exec sw15 ovs-vsctl add-port s15 gre0 -- set interface gre0 type=gre options:remote_ip=172.28.5.12
...
#sw14 x sw15
docker exec sw14 ovs-vsctl add-port s14 gre2 -- set interface gre2 type=gre options:remote_ip=172.28.5.16
docker exec sw15 ovs-vsctl add-port s15 gre1 -- set interface gre1 type=gre options:remote_ip=172.28.5.15 
