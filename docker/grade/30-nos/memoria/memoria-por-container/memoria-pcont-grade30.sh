# /bin/bash
echo "Contador Consumo" >>"topologia-grade-containers-memoria".ods
i=0
tempo=300
...
do
	...
	echo $i $resul0 $resul1 $resul2 $resul3 $resul4 $resul5 $resul6 $resul7 $resul8 $resul9 $resul10 $resul11 $resul12 $resul13 $resul14 $resul15 $resul16 $resul17 $resul18 $resul19 $resul20 $resul21 $resul22 $resul23 $resul24 $resul25 $resul26 $resul27 $resul28 $resul29 $resul30 $resul32 $resul33 >>"topologia-grade-containers-memoria".ods
	sleep 2
	i=`expr $i + 1`
done
