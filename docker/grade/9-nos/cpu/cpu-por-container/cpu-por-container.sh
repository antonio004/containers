# /bin/bash
echo "Contador cpu$" >>"cpu-pcont-grade9-containers".ods
i=0
...
do	
	...
	echo $contr $stch0 $stch1 $stch2 $stch3 $stch4 $stch5 $stch6 $stch7 $stch8 $host0 $host1 >>"cpu-pcont-grade9-containers".ods
