...
i=0
tempo=300
c="e6893bc271df1a44d1adf50f53d7ff4e5a49b5ca75eb350136294f6e7eead063"
...
do
	...
	resul=`echo "scale=4 ; (($val0+$val1+$val2+$val3+$val4+$val5+$val6+$val7+$val8+$val9+$val10+$val11+$val12+$val13+$val14+$val15+$val16+$val32+$val33)/$intervalo)"  | bc`
	...
	echo $resul >>"memoria-grade-30".ods
