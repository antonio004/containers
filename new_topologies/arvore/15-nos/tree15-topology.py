...
def Topology():
    ...
    link1 = HostLinkVeth(node_host = h1, node_target = n9, ip_host = "10.0.0.1/24", mtu = "9000")
    link2 = HostLinkVeth(node_host = h2, node_target = n31, ip_host = "10.0.0.2/24", mtu = "9000")
