...
if __name__ == '__main__':
    ...
    l3 = dp.addLink(LinkPair(name="l3", node_source=sw2, node_target=sw4, type=LinkType.DIRECT))

    l4 = dp.addLink(LinkPair(name="l4", node_source=sw1, node_target=sw5, type=LinkType.DIRECT))
    l5 = dp.addLink(LinkPair(name="l5", node_source=sw5, node_target=sw6, type=LinkType.DIRECT))
    l6 = dp.addLink(LinkPair(name="l6", node_source=sw5, node_target=sw7, type=LinkType.DIRECT))


    hl1 = dp.addLink(LinkPair(name="hl1", node_source=h1, node_target=sw3, type=LinkType.HOST))
    hl2 = dp.addLink(LinkPair(name="hl2", node_source=h2, node_target=sw7, type=LinkType.HOST))
