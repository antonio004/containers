...
do	
	...
	echo $i $contr $stch0 $stch1 $stch2 $stch3 $stch4 $stch5 $stch6 $stch7 $stch8 $stch9 $stch10 $stch11 $stch12 $stch13 $stch14 $host0 $host1 $host2 $host3 $host4 $host5 $host6 $host7 >>"cpu-tree-containers".ods
	i=`expr $i + 1`
done
