...
i=0
tempo=300
c="36360f280242cd0155b686ce1f72a72ec5f17eec111e155b10b93dc8190b4014"
...
do
	...
	resul=`echo "scale=4 ; (($val0+$val1+$val2+$val3+$val4+$val5+$val6+$val7+$val8+$val9+$val10+$val11+$val12+$val13+$val14+$val15+$val32+$val33+$val34+$val35+$val36+$val37+$val38+$val39)/$intervalo)"  | bc`
	...
	echo $i $resul >>"topologia-tree-memoria".ods
