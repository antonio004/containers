# /bin/bash
echo "Contador Consumo" >>"topologia-pcont-grade16".ods
i=0
tempo=300
...
do
	...
	echo $resul0 $resul1 $resul2 $resul3 $resul4 $resul5 $resul6 $resul7 $resul8 $resul9 $resul10 $resul11 $resul12 $resul13 $resul14 $resul15 $resul32 >>"topologia-pcont-grade16".ods
	sleep 2
	i=`expr $i + 1`
done
