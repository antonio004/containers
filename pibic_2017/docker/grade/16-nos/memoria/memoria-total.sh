# /bin/bash
echo "Contador Consumo" #>>"topologia-grade16-memoria".ods
i=0
tempo=300
c="3bb23a0c5740e2307a0543e1c8fe013be256cdd04f213d6adb6ae968d2a4fa4f"
...
do
	...
	echo $resul >>"topologia-grade16-memoria".ods
