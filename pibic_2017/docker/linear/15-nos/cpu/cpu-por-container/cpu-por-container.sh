# /bin/bash
echo "Contador cpu$" >>"cpu-pcont-linear15-containers".ods
i=0
...
do	
	...
	echo $contr $stch0 $stch1 $stch2 $stch3 $stch4 $stch5 $stch6 $stch7 $stch8 $stch9 $stch10 $stch11 $stch12 $stch13 $stch14 $host0 $host1 >>"cpu-pcont-linear15-containers".ods
