...
i=0
c="7eb9ce43e7f93451f12055939a276b51509311e4bf79704d3a67300f94c1235a"
...
do	
	...
	cpu_total=`echo "scale=4 ; ($contr+$stch0+$stch1+$stch2+$stch3+$stch4+$stch5+$stch6+$stch7+$stch8+$host0+$host1)"  | bc`
	echo $cpu_total >>"cpu-grade-30".ods
	i=`expr $i + 1`
done
