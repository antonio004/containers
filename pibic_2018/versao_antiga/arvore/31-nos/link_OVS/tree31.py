...
def Topology():
    ...
    link1 = HostLinkOvs(node_host = h1, node_target = n9, ip_host = "10.0.0.1/24", mtu = "9000")
    link2 = HostLinkOvs(node_host = h2, node_target = n31, ip_host = "10.0.0.2/24", mtu = "9000")
    ...
    link7 = DirectLinkOvs(node_source = n4, node_target = n6, mtu = "9000")
    link8 = DirectLinkOvs(node_source = n3, node_target = n7, mtu = "9000")
    link9 = DirectLinkOvs(node_source = n7, node_target = n8, mtu = "9000")
    link10 = DirectLinkOvs(node_source = n7, node_target = n9, mtu = "9000")


    link11 = DirectLinkOvs(node_source = n2, node_target = n10, mtu = "9000")
    link12 = DirectLinkOvs(node_source = n10, node_target = n11, mtu = "9000")
    link13 = DirectLinkOvs(node_source = n11, node_target = n12, mtu = "9000")
    link14 = DirectLinkOvs(node_source = n11, node_target = n13, mtu = "9000")
    link15 = DirectLinkOvs(node_source = n10, node_target = n14, mtu = "9000")
    link16 = DirectLinkOvs(node_source = n14, node_target = n15, mtu = "9000")
    link17 = DirectLinkOvs(node_source = n14, node_target = n16, mtu = "9000")
    

    link18 = DirectLinkOvs(node_source = n1, node_target = n17, mtu = "9000")
    link19 = DirectLinkOvs(node_source = n17, node_target = n18, mtu = "9000")
    ...
    link26 = DirectLinkOvs(node_source = n17, node_target = n25, mtu = "9000")
    ...
    link29 = DirectLinkOvs(node_source = n26, node_target = n28, mtu = "9000")
    link30 = DirectLinkOvs(node_source = n25, node_target = n29, mtu = "9000")
    link31 = DirectLinkOvs(node_source = n29, node_target = n30, mtu = "9000")
    link32 = DirectLinkOvs(node_source = n29, node_target = n31, mtu = "9000")
